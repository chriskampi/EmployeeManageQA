...
def is_ui(config: dict) -> bool:
    return str(config.get("test_mode", "../Tests/API")).lower() == "ui"
...
def actions(driver, config: dict):
    ...
    from selenium_action_utils import SeleniumActions
...
def pytest_runtest_setup(item: pytest.Item) -> None:
    ...
    mode = (override or load_config(cfg_path).get("test_mode", "../Tests/API")).lower()
